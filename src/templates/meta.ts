export function renderMeta(shortUrl: string, targetUrl: string, slug: string) {
  ...
  <html lang="en">
    <head>
      ...
      <title>Short Link Preview</title>
      ...
      <meta property="og:title" content="Short Link Preview" />
      <meta property="og:url" content="${shortUrl}" />
      <meta property="og:description" content="Redirects to: ${targetUrl}" />
      <meta property="og:type" content="website" />
      <meta name="twitter:card" content="summary" />
      <meta name="twitter:title" content="Short Link Preview" />
      <meta name="twitter:description" content="Redirects to: ${targetUrl}" />
      <style>
        :root {
          --bg: #f9fafb;
          --card: #ffffff;
    ...
    <body>
      <div class="wrap">
        <div class="hero"><div class="title">Short Link Preview</div></div>
        <div class="card">
          <div>Short URL: <a class="link" href="${shortUrl}">${shortUrl}</a></div>
          <div class="row">Destination: <a class="link" href="${targetUrl}">${targetUrl}</a></div>
